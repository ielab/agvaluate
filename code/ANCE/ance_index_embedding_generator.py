...
from transformers import RobertaTokenizer, PreTrainedModel, RobertaConfig, RobertaModel
import torch
...
if __name__ == '__main__':
    ...
    # model = AnceEncoder.from_pretrained(cache_dir=args.cache)
